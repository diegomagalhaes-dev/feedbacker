<template>
  <teleport to="body">
    <!-- Na div abaixo temos o overlay do modal (fundo semitransparente) -->
    <!-- Com a condição abaixo, só temos o modal aparecendo caso que o invoque passe para true a propriedade isActive que é false por default  -->
    <div
      v-if="state.isActive"
      class="
        fixed
